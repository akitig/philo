...
/*   Updated: 2025/03/09 21:44:43 by akunimot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * simulation_running:
 *    stop_mutex をロックして simulation_stop フラグをチェックし、
...
/*
 * safe_sleep:
 *    指定されたミリ秒分、100µs ごとに simulation_stop をチェックしながら待機する。
...
/*
 * safe_print:
 *    出力前に print_mutex をロックし、simulation_stop がセットされていなければ
 *    指定のフォーマットで出力する。
 */
